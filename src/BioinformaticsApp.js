...
class BioinformaticsApp {
  ...
  /**
   * Validates input type of the data used in this application. If valid, return the 
   * data type string in {DataType} constant. This is a helper function to validate and 
   * set dataType in constructor in this class.
   * @param {string} dataType, the string represtive of the type of the input data.
   *  must be "DNA", "RNA", "protein", or "pdb".
   * @returns {string} data type string in {DataType} object.
   * @throws exception if input dataType is not valid.
   */
  ...
  /**
   * Sets the {FastaSeq} fasta sequences for {BioinformaticsApp}.
